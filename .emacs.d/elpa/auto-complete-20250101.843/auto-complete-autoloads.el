...
With prefix ARG, enable Global Auto-Complete mode if ARG is positive; otherwise, disable
it.
...
Auto-Complete mode is enabled in all buffers where `auto-complete-mode-maybe' would do
it.
